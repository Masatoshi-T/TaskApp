package jp.techacademy.masatoshi.tashiro.taskapp;
...
public class MainActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query.equalTo("category",categoryWord);
        RealmResults<Task> results1 = query.findAll();
    ...
    private void reloadListView() {
        ...
        if (categoryWord.length() > 0 ){
            for (int i = 0; i < mTaskRealmResults.size(); i++) {
                if (mTaskRealmResults.get(i).getCategory().equals(categoryWord)) {
                    Task task = new Task();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                categoryWord = newText;
                Log.d("Test", categoryWord);
                reloadListView();
                return true;
            }
        });
